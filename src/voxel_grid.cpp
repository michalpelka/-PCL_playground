...
int main (int argc, char** argv)
{
  ...
  /// models
  dataTransformation inputModel;
  dataTransformation outputModel;
  ...
  std::cout <<"pointclouds to filter "<< cloud_ids.size() <<"\n";
